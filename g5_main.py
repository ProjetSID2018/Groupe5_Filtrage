...
from functions.g5_calcul_idf import get_tf_idf
"""============================================================================
    links
============================================================================"""
...
#idf = pickle.load(open('/var/www/html/projet2018/code/filtering/functions/lemma_idf.p', 'rb'))
...
articles = {key: articles[key] for key in list(articles)[0:20]}
...
#        
#        log_post = post_tfidf(get_tf_idf(filtered['list_lemma'], art))
        log_post = get_tf_idf(filtered['list_lemma'], art)
        #ifile = path_post_target + '/' + item + '_post_tf.json'
        ifile = path_target + '/' + item + '_post_tf.json'
        with open(ifile, 'w', encoding='utf-8') as outfile:
            json.dump(log_post, outfile, ensure_ascii=False)
